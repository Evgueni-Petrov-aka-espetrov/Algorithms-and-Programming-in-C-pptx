...
* Примеры использования атомарных переменных -- синхронизации потоков producer-consumer, асинхронный счётчик
...
* Основные понятия и определения машинного обучения, примеры задач регрессии, классификации и ранжирования -- на основе [1-й лекции из курса по машиинному обучению Воронцова К.В.](http://www.machinelearning.ru/wiki/index.php?title=Машинное_обучение_%28курс_лекций_К.В.Воронцов%29)
