...
* Обзор операторов -- требования к операндам, исполнение, побочные эффекты, undefined behavior, implementation-specific behavior
...
## [Лекция 9 Очередь, дек, граф](https://github.com/Evgueni-Petrov-aka-espetrov/Algorithms-and-Programming-in-C-pptx/blob/master/09%20Списки%20%28продолжение%29%20Графы.pptx)
